// Tailwind v4 default colour values, from tailwindcss 4.3.3 theme.css (2026-09-16).
// A restated name whose value differs from these was retuned on purpose.
// Re-check on every Tailwind release, with PALETTE in shadcn-data.mjs.
